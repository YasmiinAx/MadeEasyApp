...
export default function ScheduleTaskScreen({ navigation }) {
    {/* Selected date, task name and time from calendar */}
    const [selectedDate, setSelectedDate] = useState("");
    const [task, setTask] = useState("");
    const [time, setTime] = useState("");
    
    {/* Access task list and add scheduled tasks */}
    const { taskList, addCalendarTask } = useTasks(); 
    
    {/* Generate time slots every 30 mins from 6AM-11PM */}
    ...
    {/* Schedule the selected task with date/time */}
    const handleSchedule = () => {
        ...
        {/* Reset the fields after scheduling */}
        setTask("");
        setTime("");
        navigation.goBack();
    };
