...
export default function CalendarScreen({ navigation }) {
    ...
    .map(task => {
        const original = taskList.find(t => t.name === task.name); // Merge original task info with calendar task
    ...
    .sort((a, b) => {
        ...
        return parseTime(a.time) - parseTime(b.time); // Sort by time
    });
    ...
    return (
        <View style={styles.container}>
            ...
            onDayPress={(day) => setSelected(day.dateString)} // Update selected date
            markingType="custom"
            markedDates={{
                ...
                ListEmptyComponent={
                    <Text style={{ color: "#A894A3", fontSize: 15, marginTop: 10 }}>No tasks scheduled</Text>
                }
                />
                </View>
            </View>
